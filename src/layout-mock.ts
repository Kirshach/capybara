export default [
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 3, x: 10, y: 3, i: 'azCzNuMatQb2F7tzRvgIu', moved: false, static: false },
      content: {
        title: 'Content-visibility: the new CSS property that boosts your rendering performance',
        url: 'https://css-tricks.com/content-visibility-the-new-css-property-that-boosts-your-rendering-performance/',
      },
      styles: { backgroundColor: '#000000', color: '#c27100' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 2, y: 0, i: 'tUgSgx8t0zVSABQDMz20L', moved: false, static: false },
      content: {
        title: 'Отзывчивый веб-дизайн и учёт высоты окна браузера / Хабр',
        url: 'https://habr.com/ru/company/ruvds/blog/525410/',
      },
      styles: { backgroundColor: '#619fbb', color: '#ffffff' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 3, h: 2, x: 5, y: 6, i: 'Rry-uPenvJQ67KNSemTFM', moved: false, static: false },
      content: {
        title: 'HTML Forms Design.  Best practice, research insights and examples',
        url: 'https://gerireid.com/forms.html',
      },
      styles: { backgroundColor: '#e5dedc', color: '#240c83' },
    },
  },
  {
    type: 'link',
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 1, h: 1, x: 19, y: 5, i: 'Ff3XSdaMvzUMFtgsF22h2', moved: false, static: false },
      content: { title: 'Academind', url: 'https://academind.com/' },
      styles: { backgroundColor: '#ffffff', color: '#fa923f' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 1, h: 1, x: 19, y: 0, i: 'bGq3jjuZRGt-ROJRviawI', moved: false, static: false },
      content: {
        title: 'A Dynamically-Sized Sticky Sidebar with HTML and CSS',
        url: 'https://css-tricks.com/archives/',
      },
      styles: { backgroundColor: '#000000', color: '#f5552e' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 0, y: 0, i: 'kBfgHU2NQx47Nqk42yLDY', moved: false, static: false },
      content: { title: 'JavaScript Operator Lookup', url: 'https://www.joshwcomeau.com/operator-lookup/' },
      styles: { backgroundColor: '#ffffff', color: '#4e3a33' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 4, y: 0, i: '5W_QI23OK8vH6npPFtcXf', moved: false, static: false },
      content: { title: 'REM vs EM – Великий спор / Хабр', url: 'https://m.habr.com/ru/post/280125/' },
      styles: { backgroundColor: '#619fbb', color: '#ffffff' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 17, y: 0, i: 'QhGvcZHmWgGBAqUoQEFeo', moved: false, static: false },
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 13, y: 2, i: 'B1va0exYOYu7IBGENIXFU', moved: false, static: false },
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 13, y: 0, i: 'xEYz-902dZtVhqAci_agU', moved: false, static: false },
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 15, y: 0, i: 'XE3pA0vcAGlPpAkYjp7bz', moved: false, static: false },
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 3, y: 4, i: 'K2LTK-tctomgPb21_nPwh', moved: false, static: false },
      content: { title: 'Custom bullets with CSS ::marker', url: 'https://web.dev/css-marker-pseudo-element/' },
      styles: { backgroundColor: '#ffffff', color: '#0c56fe' },
    },
  },
  {
    type: 'link',
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 3, h: 2, x: 5, y: 4, i: 'fGuyoSOvt_EPFpDpJfLm7', moved: false, static: false },
      content: {
        title: 'Introducing Web APIs for Dual Screen and Foldable Devices',
        url: 'https://blogs.windows.com/msedgedev/2020/09/14/introducing-dual-screen-foldable-web-apis/',
      },
      styles: { backgroundColor: '#ffffff', color: '#0577d6' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 4, h: 2, x: 8, y: 8, i: 'EvKQNDjRMukQUF253OKzJ', moved: false, static: false },
      content: {
      ...
      styles: { backgroundColor: '#1d1d26', color: '#fd1992' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 10, y: 6, i: 'fIEECtsAoCvi9GjmquhNy', moved: false, static: false },
      content: { title: 'Animating with Clip-Path', url: 'https://css-tricks.com/animating-with-clip-path/' },
      styles: { backgroundColor: '#000000', color: '#c27100' },
    },
  },
  {
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 3, h: 2, x: 3, y: 2, i: 'qY63ym8qd4UwSfADpsOeD', moved: false, static: false },
      content: {
        title: 'What is Project Fugu? More power to the web',
        url: 'https://felixgerschau.com/web-capabilities-project-fugu-google/',
      },
      styles: { backgroundColor: '#d6eaff', color: '#0e69ce' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 3, x: 10, y: 0, i: '7GosZXM-dLgQ-reUnt2Bh', moved: false, static: false },
      content: {
        title: 'Browser Rendering Optimization by Google - Udacity',
        url: 'https://www.udacity.com/course/browser-rendering-optimization--ud860',
      },
      styles: { backgroundColor: '#eb962d', color: '#ffffff' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 4, h: 2, x: 6, y: 0, i: 'IxsNnI_tJerMBuWEnlZuk', moved: false, static: false },
      content: {
      ...
      styles: { backgroundColor: '#ffffff', color: '#1c6da8' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 3, h: 2, x: 5, y: 8, i: 'V1ZK4Q-JhdiVOKJLRVmiZ', moved: false, static: false },
      content: {
        title: 'THE FONT LOADING CHECKLIST - ZACH LEATHERMAN',
        url: 'https://www.zachleat.com/web/font-checklist/',
      },
      styles: { backgroundColor: '#3c5a3c', color: '#ffffff' },
    },
  },
  {
    type: 'link',
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 4, h: 2, x: 6, y: 2, i: '95HMCzPtwXSnK9h6nuEP9', moved: false, static: false },
      content: {
      ...
      styles: { backgroundColor: '#02256c', color: '#ffffff' },
    },
  },
  {
    type: 'link',
    data: {
      ...
      styles: { backgroundColor: '#7549bc', color: '#ffffff' },
    },
  },
  {
    type: 'link',
    data: {
      grid: { w: 1, h: 1, x: 19, y: 1, i: 'UcRBJEIztpy583QUC2zr5', moved: false, static: false },
      content: { title: 'git --everything-is-local', url: 'https://git-scm.com/book/ru/v2' },
      styles: { backgroundColor: '#ffffff', color: '#f64c27' },
    },
  },
  {
    type: 'link',
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 15, y: 2, i: 'xbd7u-9aRBHATOPBcDq9g', moved: false, static: false },
  ...
  },
  {
    type: 'link',
    data: {
      grid: { w: 2, h: 2, x: 8, y: 4, i: 'MztbVkoY4KE9yTBjn7yXs', moved: false, static: false },
      content: {
